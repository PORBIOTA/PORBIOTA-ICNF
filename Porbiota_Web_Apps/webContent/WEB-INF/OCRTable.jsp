...
<head>
<meta charset="UTF-8">
<title>OCR Table</title>
</head>
<body>
	<a href="/Porbiota_Web_Apps">Go back</a>
	<center>
		<h1>Select one table image to OCR:</h1>
		...
		<p><b>Takes as input .JPG, .TIF and .PNG files.</b></p>	
	
	<p>Creates a .CSV by performing OCR on an image using tesseract.</p>
	<p>If the table is unsatisfactory, try <a href="https://www.onlineocr.net/">this site</a>.</p>
</body>