...
hasZ <- names(dataframed)[ncol(dataframed)] == "coords.x3"
...
if (hasZ) {
	colnames(dataframed)[ncol(dataframed)-1] <- "verbatimLatitude"
	colnames(dataframed)[ncol(dataframed)-2] <- "verbatimLongitude"
	colnames(dataframed)[ncol(dataframed)] <- "verbatimAltitude" 
	dataframed <- dataframed[,c(1:(ncol(dataframed)-3),ncol(dataframed),ncol(dataframed)-2,ncol(dataframed)-1)]
} else {
...
if (hasZ) {
	colnames(dataframedWGS84)[ncol(dataframedWGS84)-1] <- "verbatimLatitude"
	colnames(dataframedWGS84)[ncol(dataframedWGS84)-2] <- "verbatimLongitude"
	colnames(dataframedWGS84)[ncol(dataframedWGS84)] <- "verbatimAltitude" 
	dataframedWGS84 <- dataframedWGS84[,c(1:(ncol(dataframedWGS84)-3),ncol(dataframedWGS84),ncol(dataframedWGS84)-2,ncol(dataframedWGS84)-1)]
} else {
